...
# Les Samfunnsfag-filen
with open('/Users/kennethbareksten/Downloads/Læreplan i samfunnsfag SAF01-04 (1).txt', 'r', encoding='cp1252') as f:
    content = f.read()

# Kjerneelementer for Samfunnsfag (fra curriculumData.ts)
CORE_ELEMENTS = [
    "Utforske samfunnsfaglige temaer",
    "Analysere samfunnsfaglig informasjon",
    "Tenke kritisk og håndtere uenighet",
    "Utforske sammenhengar i tid og rom",
    "Utøve demokratisk medborgarskap"
]
...
def parse_goals():
    ...
    for i in range(1, len(sections), 2):
        ...
        # Finn alle mål (linjer som starter med nummer eller *)
        ...
        goal_objects = []
        base_code = {"2": 1, "4": 14, "7": 27, "10": 44}[level]
...
# Erstatt Samfunnsfag
all_data['SAF'] = saf_data

# Skriv tilbake
with open('data/competenceGoals.json', 'w', encoding='utf-8') as f:
    json.dump(all_data, f, ensure_ascii=False, indent=2)

print("\n✓ Samfunnsfag oppdatert!")
print(f"Totalt: {sum(len(goals) for goals in saf_data['levels'].values())} mål")
