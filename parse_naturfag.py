...
# Les Naturfag-filen
with open('/Users/kennethbareksten/Downloads/Kompetansemål NAT01-04.txt', 'r', encoding='cp1252') as f:
    content = f.read()

# Kjerneelementer for Naturfag (fra curriculumData.ts)
CORE_ELEMENTS = [
...
def parse_goals():
    ...
    for i in range(1, len(sections), 2):
        ...
        goal_objects = []
        base_code = {"2": 1, "4": 11, "7": 28, "10": 49}[level]
...
print("\n✓ Naturfag oppdatert!")
print(f"Totalt: {sum(len(goals) for goals in nat_data['levels'].values())} mål")
